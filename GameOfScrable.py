...
data = {1: "AEIOULNSTRАВЕИНОРСТ", 2: "DGДКЛМПУ", 3: "BCMPБГЁЬЯ", 4: "FHVWYЙЫ", 5: "KЖЗХЦЧ", 8: "JXШЭЮ", 10: "QZФЩЪ"}
word = input("Введите слово: ").upper()

print("Стоимость введенного слова", sum([k for i in word for k, v in data.items() if i in v]), "очков")
